...
function Projects() {
    ...
    const [previousProject, setPreviousProject] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
                        ...
                        "Projects.useEffect": (entry)=>{
                            if (entry.isIntersecting) {
                                const index = projectRefs.current.findIndex({
                                    "Projects.useEffect.index": (ref)=>ref === entry.target
                                }["Projects.useEffect.index"]);
...
_s(Projects, "vVvOO4FD0bnSisGiSLpRaoRGkIs=");
_c = Projects;
var _c;
